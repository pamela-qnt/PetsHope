<div style='background-color: #3b3b3b; padding-top: 1%; '>
	<?php
        ...
        $categoria = $_GET['tipo'];
        echo "<h1 style='margin-left: 11%; color: white; margin-bottom: 1%; font-size: 330%;'>Gerenciar Produtos - " . $categoria . "</h1>";
	?>
	</div>
	...
	<?php
        try {
            $query = 'SELECT id_produto, nome_produto, qtd_estoque, desc_produto, valor, img_produto FROM produto, tipo_produto WHERE id_tipo_prod = id_tipo_prod_fk and desc_tipo_prod = "'.$categoria.'"';
    ...
    ?>
                <div style="border: dashed; border-width: 1px; border-radius: 2px; margin-bottom: 2%; width: 25%; float: left; margin-left: 6%; padding: 0.5%; margin-top: 2%;">
                    ...
                    <?php
                    print_r("<b><a href='produto_ind.php?id_produto=$id' style='text-decoration: none; color: black;'>" . $row['nome_produto'] . "</a></b>");
                    echo "<br>";
