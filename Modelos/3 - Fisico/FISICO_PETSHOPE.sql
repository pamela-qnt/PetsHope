...
('Guia com amortecedor para cachorros', 125.00, 5, 1),
('Guia para cachorros Salina', 79.00, 10, 1),
('Guia para cachorros Florida', 79.00, 4, 1),
('Guia para cachorros Patagonia', 79.00, 6, 1), 
('Guia para cachorros Game of Thrones', 99.00, 3, 1),
('Coleira para cachorros Florida', 45.00, 2, 2), 
('Coleira para cachorros Salina', 45.00, 7, 2),
('Coleira para cachorros Patagonia', 45.00, 5, 2),
('Coleira para cachorros Donna', 45.00, 6, 2),
('Coleira para cachorros Neopro Verde Limao', 59.00, 3, 2),
